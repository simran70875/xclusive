...
const AppSidebar: React.FC = () => {
  ...
  if (adminUser?.type === "agent") {
    const blockedNavNames = ["Manage Products", "Manage Agents"];
    const blockedOthersNames = ["Add Floating Banner",  "Manage Top Banners", "User Queries", "Manage Categories", "Manage Brands"];
