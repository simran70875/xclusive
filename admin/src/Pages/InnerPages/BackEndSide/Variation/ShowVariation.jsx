...
const Showvariation = () => {
  ...
  const handleCloseAddVariationModel = async () => {
    ...
    const res = await axios.get(
      `${url}/product/get/${selectedVariationData?._id}`,
      {
        headers: {
    ...
    },
    {
      ...
      renderCell: (params) => (
        <img
          ...
          onClick={() =>
            handleImageClick(
              params?.row?.variation_Images?.[0]?.variation_Image
            )
          }
        />
      ),
    ...
    },
    {
      ...
      renderCell: (params) => (
        <Stack direction="row">
          ...
          <IconButton aria-label="edit" onClick={() => handleOpenModal(params)}>
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          ...
          .then(() => {
            setvariationData(
              variationData?.filter((d) => !idsToDelete?.includes(d?._id))
            );
            Swal.fire("Success!", "variation has been deleted!", "success");
          })
          .catch((err) => {
      ...
      <div className="main-content">
        <div className="page-content">
          <div className="container-fluid">
            <div className="row">
              <div className="col-2 table-heading">Gold Variations List</div>
              <div className="d-flex flex-wrap gap-2 mt-2">
                <button
                  onClick={() => handleOpenAddVariationModel()}
