...
const AddCoins = () => {
  ...
  console.log("add coins details ==> ", details);
  ...
  useEffect(() => {
    if (details && details.fromOrders) {
        setUserType(details.userType === "User" ? "3" : "4");
        setSelectedUser(details.userId);
      }
  ...
  const handleSubmit = async (e) => {
    ...
    console.log(amount, selectedUser, userType, transType);
                        ...
                        <div className="col ms-auto">
                          <div className="d-flex flex-reverse flex-wrap gap-2">
                            <a
                              ...
                              onClick={() => Navigate("/showCoinsHistory")}
                            >
                              {" "}
