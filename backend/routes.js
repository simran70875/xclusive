...
const PaymentRoute = require("./Routes/BackendSide/payment_route.js");
...
route.use("/memberShip", MemberShipRoute);
route.use("/memberShip/history", MemberShipHistoryRoute);
route.use("/wallet/history", WalletRoute);
route.use("/coupon", CouponRoute);
route.use("/app/settings", SettingsRoute);
route.use("/review", ReviewRoute);
route.use("/coins/history", CoinsRoute);
